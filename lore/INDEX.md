...
|--------|----------------|--------|
| Workplace as trap | Isolation baked into the job, not contrived lockdown | Strong — authenticity 07-19; protocol/rules-as-threat 07-22; oversized empty plant 07-23; grim overtime 07-24; cheerful debt-PA 07-25; facility-as-home 07-26; empty-station archaeology / hub-spoke berths (Tacoma) 07-27; lonely-job radio (Firewatch) + Teamster labor (Mothership light) 07-28; station-as-warm-home + filter labor (Metro) + SOP/table-as-trap (Inscryption careful) 07-29; leased-body labor budget / stabilizer leash (Citizen Sleeper) + overtime lure (DREDGE day calm) 07-31; industrial-as-complicated-beauty (NORCO) + anti-adventure cleanup wage trap (Spaceport Janitor) 08-01; engineer keep-the-lights-on (Moons) + wry bureaucratic stagnation (Disco light) + maintenance override under broken command (Job Interview) 08-02; hideout prep labor / day-rebuild night-pressure (Darkwood careful) + Belter extractive grids (Expanse light) + deferred work-order triage fiction (Best-Laid Plans) 08-04; commit-on-submit investigation sheets / bureaucratic noir labor (Lacuna light) + gardener containment vs hygiene SOP fiction (Irene/Hipea) 08-05; **learned-job mastery until dread (Voices of the Void) + hospitality-contract trap fiction (Shelter)** 2026-08-07 |
| Industrial biomass / hive | Threat uses vents, heat, logistics; ship becomes habitat | Upgraded 07-20 Flood staging; Carrion habitat + path-to-source 07-24; Bunker noise/light 07-25; warm-dark nests 07-26; impregnate-don't-replace (Scorn careful) + duct habitat 07-27; forecastable surge / take-shelter (STALKER careful) 07-28; purposeless megastructure growth (BLAME! visual) + clean line over under-deck harvest 07-29; omnipresent sticky weather / plague-air (Pathologic careful) + knowing-as-infection fiction 07-31; hive-as-longed-for-home / tempting foothold (You Dream of the Hive motif) 08-01; semi-passive place hazards / material anomalies (Into the Radius careful — not Emission) 08-02; hard-SF inorganic swarm humility / necroevolution parallel (Invincible careful — not our biomass art) 08-04; quiet stealth infection clock + false-bargain late stage (Barotrauma husk deepen) + biomass that can choose HVAC/pipes (Irene/Hipea) 08-05; **architecture impregnation / building-as-shell fiction (Shelter) + overnight bay redecoration (We Went Back light)** 2026-08-07 |
| Factory pressure = identity | Enemies tied to production loop (Factorio pollution lesson) | Strong; WaveFuel/HiveDebt 07-23; path-to-hottest + foothold caps 07-24; ONI ripples + expansion cascade 07-25; quality hunters 07-26; expansion sidegrade poison (Lobotomy anti-comp) 07-27; failure tax not panic HUD (Mothership) + siege-around-the-line 07-28; manual≠machine asymmetry + trip-when-healthy pacing (KTANE anti-comp) 07-29; cannot-save-every-bay triage + false-security overtime (Pathologic / DREDGE); Satisfactory joyful-factory anti-comp invert 07-31; aftermath residue as labor beat (Janitor); fog occlusion changes how you work the line (GTFO careful) 08-01; logistics choke / through-vs-local flow hierarchy (InfraSpace light) 08-02; prep-before-surge valleys + generator/light as containment spend (Darkwood careful; kin to Bunker clock) 08-04; intentional cascading overload from ordinary ops + bays that must have solvable problems (Barotrauma deepen) 08-05; **unresolved-time corruption clock (Quasimorph careful) + VotV breaker/server triage as calm labor pressure** 2026-08-07 |
| Diegetic dread | Diegetic UI, failing systems, environmental storytelling | Upgraded 07-20; Mixer EQ 07-22; delayed scanner 07-23; atmosphere bricks 07-24; power clock + empty HUD 07-25; mediated cams 07-26; systems-as-interface (Observation) + CRT-Free 07-27; ISO signage + hold-to-listen radio 07-28; Metro filter/watch diegesis + Shipbreaker cassette boards / floor-ceiling cues 07-29; player-centered fog close-in + abandoned beacon stay-away + work-light practicals 07-31; utilitarian patina / Remus→Romulus retrofit eras (Romulus craft) + per-bay bespoke light + fuse-box fault bulbs 08-01; security booth map/roster bones (Prey deepen) + Signalscope-style distant bay beacon (Outer Wilds deepen) + control-panel / ammeter faces 08-02; atompunk minimal HUD + held tools (Invincible) + cheap intentional-friction terminals (Hypnospace careful) + corporate PDA voice (Subnautica light) + peel-through era walls (Pentiment light) 08-04; commit-on-file sheets (Lacuna) + Starlight held dossier (Paradise Killer light) + SOMA take-the-world-seriously prop grammar + vintage facility placards 08-05; **Isolation lo-fi pre-1979 / VHS-CRT screens + five bay archetypes (craft deepen) + VotV physical drives/buttons anticipation systems + mixed-era power panel wishlist** 2026-08-07 |
| Lonely worker fantasy | Rustic space labor, patched ship, schedule vs survival | Strong — recovery beats; dual view; distant-signal 07-22; absent-crew 07-23; purposeless factory 07-24; refuel valley 07-25; bay-as-garage 07-26; ghost-in-the-HVAC 07-27; berth-as-house FP densify (Returnal) + naming-the-station 07-28; empty-protocol routines (Last Employee) + labor tools not magic SF 07-29; architecture-not-for-you FP voids (NaissanceE) + body-as-leased-tool labor texture 07-31; proud lonely plant vista (NORCO) + scavenger-small under distant agendas (Forever Winter light) 08-01; Mars-technician solitude before payoff (Moons) + travelers-as-shared-song loneliness (Outer Wilds deepen) 08-02; bitter-hope hard-SF solitude + radio companion (Invincible) + sterile corporate survival voice (Subnautica PDA) 08-04; enclosed megacity / eye-height crush under artificial sky (Stray light) + gardener lonely containment labor (Irene/Hipea) 08-05; **solo array/shift mastery in silence (Voices of the Void) + abandoned station alone revisits (We Went Back light)** 2026-08-07 |
...
- Alien: Isolation (isolation + Director/menace pacing + Working Joe protocol threat + **lo-fi pre-1979 / bay archetypes craft deepen** 08-07)
...
- Pathologic 2 (**omnipresent plague-air dread / cannot-save-everyone triage** — careful; refuse town-sim / plot primary)
- DREDGE (**day-calm overtime lure + player-centered fog / unsettle-not-jump-scare** — careful; refuse panic meter / fishing)
- Citizen Sleeper (**leased-body Condition / stabilizer leash as labor budget** — careful; refuse narrative RPG / dice UI)
- NaissanceE (**architecture-not-for-you / chiaroscuro FP voids** — visual/FP; refuse walking-sim primary)
- Satisfactory (**joyful therapeutic factory** — **anti-comp** invert; keep FP scale literacy only)
- NORCO (**industrial landscape as complicated beauty / banal corporate sci-fi** — careful; refuse point-and-click adventure primary)
- Diaries of a Spaceport Janitor (**anti-adventure cleanup wage trap** — deepen aftermath labor; refuse comedy bazaar)
...
- The Invincible (**atompunk tools + anxiety-not-jumpscares + radio companion** — careful; refuse walking-sim primary / Lem swarm paste)
- Darkwood (**day prep / night house-as-trap + FOV unknown + generator light clock** — careful; refuse TD wave grind / folklore forest)
- Pentiment (**pentimento era layers under paint** — light; refuse medieval mystery primary)
- Hypnospace Outlaw (**diegetic OS / intentional cheap friction** — careful; refuse desktop-sim comedy)
- Subnautica (**PDA as lonely corporate survival tool** — light; refuse ocean crafting primary)
- The Expanse Belters (**extractive labor / grids as lifeblood** — light texture; refuse show IP / revolution plot)
- Lacuna (**commit-on-submit investigation sheets / bureaucratic noir labor** — light; refuse detective VN primary)
- SOMA (**design pillars / existential dread as seriousness frame** — deepen; refuse walking-sim / consciousness-plot primary)
- Barotrauma (**cascading overload + stealth husk false bargain** — deepen; refuse co-op clown / sub-sim primary)
- Paradise Killer (**Starlight held dossier** — light; refuse vaporwave open-world mystery primary)
- Stray (**enclosed megacity / eye-height crush under artificial sky** — light; refuse cute-cat comedy identity)
- Voices of the Void (**lonely job-sim mastery / physical diegetic tools / anticipation systems** — careful; refuse woodland jumpscare FPS / FNAF / hunger-sim primary)
- We Went Back (**overnight environment rewrite / retro abandoned station** — light; refuse PT clone / jump-scare / escape-room primary)
- Quasimorph (**time-on-site corruption clock under corporate greed** — careful; refuse turn-based extraction / PMC clones / demon lore)
...
- Date: 2026-08-07
- Landed on: `main`
- Focus weight: Voices of the Void lonely job-sim (careful); Alien Isolation lo-fi / bay-archetype craft deepen; We Went Back changing station (light); Quasimorph unresolved-time corruption (careful); Shelter architecture-impregnation fiction; free Street Props BiRP barriers; Industrial Power Control Panel wishlist (~$20 Built-in listed)
- **Bible absorbed:** pending `/lore-bible` (Last absorbed research still 2026-07-29; 07-31 + 08-01 + 08-02 + 08-04 + 08-05 + 08-07 digests unabsorbed)
- Prior run: 2026-08-05 (Lacuna; SOMA deepen; Barotrauma deepen; Paradise Killer; Stray; Irene/Hipea; Dirty Road Sign free; Vintage Facility Signs wishlist)
- Render pipeline note: project currently **Built-in** (prefer Built-in-compatible kits; Wet Stuff needs Deferred cameras; skip URP-only gauges/cones/warning-sign packs)
